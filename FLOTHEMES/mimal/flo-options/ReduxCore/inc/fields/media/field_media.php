...
if ( ! class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media {
        ...
        public function render() {
	        ...
	        global $flo_options;
			if($this->value['url'] == '' && $this->value['thumbnail'] == '' && count($this->value) > 5){
				/*if image uploaded from customizer*/
					$this->value['url'] = $flo_options[$this->field['id']];
					$this->value['thumbnail'] = $flo_options[$this->field['id']];
			}
            ...
            if(!$this->value['height'] || $this->value['height'] == '' && !$this->value['width'] ||
                $this->value['width'] == ''):
                echo '<img class="redux-option-image" id="image_' . $this->field['id'] . '" src="' .
                    $this->value['url'] . '" alt="" target="_blank" rel="external" />';
            else:
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'flotheme' ) . '</span>';
            ...
            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'flotheme' ) . '</span>';
