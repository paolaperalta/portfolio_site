...
(function( $ ) {
            ...
            function() {
                ...
                el.each(
                    function() {
                        ...
                        //init when value is changed
                        $( this ).find( '.redux-typography-size, .redux-typography-size-mobile, .redux-typography-size-tablet, .redux-typography-height, .redux-typography-height-mobile, .redux-typography-height-tablet, .redux-typography-word, .redux-typography-letter, .redux-typography-letter-mobile, .redux-typography-letter-tablet, .redux-typography-align, .redux-typography-transform, .redux-typography-font-variant, .redux-typography-decoration' ).keyup(
                            function() {
                                redux.field_objects.typography.select( $( this ).parents( '.redux-container-typography:first' ) );
                            }
                        );
                        ...
                        $( this ).find( ".redux-typography-height, .redux-typography-height-mobile, .redux-typography-height-tablet, .redux-typography-word, .redux-typography-letter, .redux-typography-letter-mobile, .redux-typography-letter-tablet" ).numeric(
                            {
                                allowMinus: true
                            }
                        );
    ...
    redux.field_objects.typography.select = function(selector) {
        ...
        var sizeMobile            = $('#' + mainID + ' .redux-typography-size-mobile').val();
        var sizeTablet            = $('#' + mainID + ' .redux-typography-size-tablet').val();
        var height          = $('#' + mainID + ' .redux-typography-height').val();
        var heightMobile          = $('#' + mainID + ' .redux-typography-height-mobile').val();
        var heightTablet          = $('#' + mainID + ' .redux-typography-height-tablet').val();
        var word            = $('#' + mainID + ' .redux-typography-word').val();
        var letter          = $('#' + mainID + ' .redux-typography-letter').val();
        var letterMobile          = $('#' + mainID + ' .redux-typography-letter-mobile').val();
        var letterTablet          = $('#' + mainID + ' .redux-typography-letter-tablet').val();
        ...
        if (sizeMobile === '') {
            $('#' + mainID + ' .typography-font-size-mobile').val('');
        } else {
            $('#' + mainID + ' .typography-font-size-mobile').val(sizeMobile + units);
        }
        if (sizeTablet === '') {
            $('#' + mainID + ' .typography-font-size-tablet').val('');
        } else {
            $('#' + mainID + ' .typography-font-size-tablet').val(sizeTablet + units);
        }
        ...
        if (heightMobile === '') {
            $('#' + mainID + ' .typography-line-height-mobile').val('');
        } else {
            $('#' + mainID + ' .typography-line-height-mobile').val(heightMobile + units);
        }
        if (heightTablet === '') {
            $('#' + mainID + ' .typography-line-height-tablet').val('');
        } else {
            $('#' + mainID + ' .typography-line-height-tablet').val(heightTablet + units);
        }
        ...
        if (letterMobile === ''){
            $('#' + mainID + ' .typography-letter-spacing-mobile').val('');
        } else {
            $('#' + mainID + ' .typography-letter-spacing-mobile').val(letterMobile + units);
        }
        if (letterTablet === ''){
            $('#' + mainID + ' .typography-letter-spacing-tablet').val('');
        } else {
            $('#' + mainID + ' .typography-letter-spacing-tablet').val(letterTablet + units);
        }
