			...
			public function render() {
				...
				if ( ! empty( $this->field['custom_fonts'] ) ) {
					...
					foreach ( $this->field['custom_fonts'] as $section => $fonts ) {
						...
						echo '</tbody></table>';
						echo '<div class="upload_button_div"><span class="button media_add_font" data-nonce="' . $nonce . '" id="' . $this->field['id'] . '-custom_fonts">' . __( 'Add Font', 'flotheme' ) . '</span></div><br />';


					}

				} else {
					echo "<h3>" . __( 'No Custom Fonts Found', 'flotheme' ) . "</h3>";
					echo '<div class="upload_button_div"><span class="button media_add_font" data-nonce="' . $nonce . '" id="' . $this->field['id'] . '-custom_fonts">' . __( 'Add Font', 'flotheme' ) . '</span></div>';
				}
