...
if (!class_exists('reduxCoreEnqueue')){
    class reduxCoreEnqueue {
        ...
        private function register_styles(){
            ...
            wp_enqueue_style(
                'redux-admin-_new_css',
                ReduxFramework::$_url . 'assets/css/redux-admin_new.css',
                array(),
                $this->timestamp,
                'all'
            );
            wp_enqueue_style(
                'generic-fields',
                ReduxFramework::$_url . 'assets/css/generic-fields.css',
                array(),
                $this->timestamp,
                'all'
            );
            ...
            wp_enqueue_style(
                'flo_admin',
                ReduxFramework::$_url . 'assets/css/flo_admin.css',
                array(),
                $this->timestamp,
                'all'
            );
        ...
        private function register_scripts() {
            ...
            wp_enqueue_script( 'flo_fancybox', get_template_directory_uri() . '/flo-options/ReduxCore/assets/js/fancybox/jquery.fancybox.js', array( 'customize-preview' ), '20130508', true );
            wp_enqueue_script('apps', get_template_directory_uri() . '/flo-options/ReduxCore/assets/js/fancybox/jquery.fancybox.pack.js', array('jquery'), '', true);
            wp_enqueue_script( 'flo_extra', get_template_directory_uri() . '/flo-options/ReduxCore/assets/js/extra.js', array( 'customize-preview' ), '20130508', true );
        ...
        private function set_localized_data(){
             ...
             */
            $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", __( 'You have changes that are not saved. Would you like to save them now?', 'flotheme' ) );
             ...
             */
            $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", __( 'Are you sure? Resetting will lose all custom values.', 'flotheme' ) );
             ...
             */
            $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", __( 'Are you sure? Resetting will lose all custom values in this section.', 'flotheme' ) );
             ...
             */
            $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'flotheme' ) );
            global $pagenow;
            $this->parent->localize_data['args'] = array(
                ...
                'please_wait'           => __( 'Please Wait', 'flotheme' ),
    ...
    global $flo_options;
    if(isset($flo_options['flo_minimal-sidebars'])){
    ...
    if( is_array( $sidebars ) && !empty( $sidebars ) ){
        foreach( $sidebars as $sidebar ){
            if(isset($sidebar['title']) && strlen(trim($sidebar['title']))){
