<?php
    class widget_tweets extends WP_Widget {
        function __construct() {
            $widget_ops = array( 'classname' => 'flo-widget tweets', 'description' => 'Display Latest tweets' );
			parent::__construct( 'widget_cosmo_tweets' , _TN_ . ' : ' . __('Latest tweets','flotheme') , $widget_ops );
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Twitter User Name' , 'flotheme' ); ?>:</label>
          <input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" type="text" value="<?php echo $username; ?>" />
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of latest tweets to show' , 'flotheme' ); ?>:</label>
        ...
        <p>
        	<label for="<?php echo $this->get_field_id( 'dynamic' ); ?>"><?php _e( 'Animated' , 'flotheme' ); ?>:</label>
        ...
        <p>
        	<span class="hint"><?php echo sprintf(__( 'Now you need to do it to create an application in %s https://dev.twitter.com/apps %s and fill the requirements there. Once finished you will have your consumer key, consumer secret, access token and access token secret.' , 'flotheme' ), '<a href="https://dev.twitter.com/apps">', '</a>' ); ?></span>
        	
        </p>

		<p>
	        <label for="<?php echo $this->get_field_id( 'consumerKey' ); ?>"><?php _e( 'Consumer key' , 'flotheme' ); ?>:</label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id( 'consumerSecret' ); ?>"><?php _e( 'Consumer secret' , 'flotheme' ); ?>:</label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id( 'accessToken' ); ?>"><?php _e( 'Access token' , 'flotheme' ); ?>:</label>
        ...
        <p>
	        <label for="<?php echo $this->get_field_id( 'accessTokenSecret' ); ?>"><?php _e( 'Access token secret' , 'flotheme' ); ?>:</label>
		...
		function followers_count($screen_name = 'flothemes')
		{
        ...
        function the_tweets( $username , $number, $dynamic, $consumerKey, $consumerSecret, $accessToken, $accessTokenSecret  ){
			...
			echo '<div class="flo-twit-container ' . $feed_classes . '">';
		...
		function get_tweets( $feed_info , $classes = '' , $before = "<div class='tweet_item'><p>" , $after = "</p></div>", $static_class = '' ){
			...
			*/
			...
			if(false === ($tweets = get_transient($transName) ) ||  get_transient($transName) == '') :
				get_template_part('/flo-options/ReduxCore/twitteroauth/twitteroauth');
			...
			if($tweets){
				...
				if( $feed_info['username'] == ''){
					_e('Please add the Twitter user name' , 'flotheme');
				}else{
					_e('Unable to read tweets !!!' , 'flotheme');
				}
