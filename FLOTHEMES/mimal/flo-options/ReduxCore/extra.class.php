<?php
    class extra{
        ...
        static function select_value( $group ){
            ...
            $result     = array( '' => __( 'main sidebar' , 'flotheme' ) );
        ...
        static function layout_a( $group ){
            ...
            if( empty( $result ) ){
                ...
                $result .= '<p>'.__('Sorry, no results found.','flotheme').'</p>';
                $result .= '</div>';
            }
        ...
        static function input( $input ){
            ...
            $hint       = isset( $hint ) ? '<div class="generic-hint ">' . $hint . '</div>': '' ;
            /* text visible */
            ...
            switch( $type ){
                ...
                case 'upload' : {
                    ...
                    $result .= '<div  class="input input-upload">';


                    $result .= '<input type="text" name="' . $name . '"  value="' . $value  . '" class="generic-record  ' . $classes . '" id="' . $id . '" />
                                <input type="button" class="button-primary" value="'.__('Choose File','flotheme').'" ' . fields::action( $id , 'upload' ) . ' />';
                    $result .= $hint;
                    $result .= '</div>';
                    $result .= '<div class="clear"></div>';
                    $result .= '</div>';
                ...
                case 'search' :{
                    ...
                    $result .= '<span class="generic-hint">' . __( 'Start typing the post tile'  , 'flotheme' ) . '</span>';
                    $result .= '</div>';
