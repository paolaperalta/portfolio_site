...
class CMB2 {
	...
	protected $mb_defaults = array(
        ...
        'grid_radio' => 'grid_radio', // or 'add-existing-user'
	);
	...
	public function __construct( $meta_box, $object_id = 0 ) {
		...
		if ( empty( $meta_box['id'] ) ) {
			wp_die( __( 'Metabox configuration is required to have an ID parameter', 'flotheme' ) );
		}
	...
	public function render_group_row( $field_group, $remove_disabled ) {
		...
		<div class="postbox cmb-row cmb-repeatable-grouping" data-iterator="', $field_group->count(), '">
			...
			<div class="cmbhandle" title="' , __( 'Click to toggle', 'flotheme' ), '"><br></div>
