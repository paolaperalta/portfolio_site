	...
	public static function register_scripts() {
		...
		if ( ! is_admin() ) {
			...
			wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
				'clear'         => __( 'Clear', 'flotheme' ),
				'defaultString' => __( 'Default', 'flotheme' ),
				'pick'          => __( 'Select Color', 'flotheme' ),
				'current'       => __( 'Current Color', 'flotheme' ),
			) );
		}
		...
		wp_localize_script( 'cmb2-scripts', 'cmb2_l10', apply_filters( 'cmb2_localized_data', array(
			...
			'defaults'         => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => __( 'mm/dd/yy', 'flotheme' ),
					'dayNames'        => explode( ',', __( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'flotheme' ) ),
					'dayNamesMin'     => explode( ',', __( 'Su, Mo, Tu, We, Th, Fr, Sa', 'flotheme' ) ),
					'dayNamesShort'   => explode( ',', __( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'flotheme' ) ),
					'monthNames'      => explode( ',', __( 'January, February, March, April, May, June, July, August, September, October, November, December', 'flotheme' ) ),
					'monthNamesShort' => explode( ',', __( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'flotheme' ) ),
					'nextText'        => __( 'Next', 'flotheme' ),
					'prevText'        => __( 'Prev', 'flotheme' ),
					'currentText'     => __( 'Today', 'flotheme' ),
					'closeText'       => __( 'Done', 'flotheme' ),
					'clearText'       => __( 'Clear', 'flotheme' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => __( 'Choose Time', 'flotheme' ),
					'timeText'      => __( 'Time', 'flotheme' ),
					'hourText'      => __( 'Hour', 'flotheme' ),
					'minuteText'    => __( 'Minute', 'flotheme' ),
					'secondText'    => __( 'Second', 'flotheme' ),
					'currentText'   => __( 'Now', 'flotheme' ),
					'closeText'     => __( 'Done', 'flotheme' ),
					'timeFormat'    => __( 'hh:mm TT', 'flotheme' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => __( 'Use this file', 'flotheme' ),
				'remove_image' => __( 'Remove Image', 'flotheme' ),
				'remove_file'  => __( 'Remove', 'flotheme' ),
				'file'         => __( 'File:', 'flotheme' ),
				'download'     => __( 'Download', 'flotheme' ),
				'check_toggle' => __( 'Select / Deselect All', 'flotheme' ),
			),
		) ) );
